Feature: Register User
  ...
  Scenario: Campo Nome vazio
    ...
    Then I should see the Register error message "O campo nome deve ser prenchido"

  Scenario: Campo E-mail vazio
    When I fill the name
    And I click on the Register button
    Then I should see the Register error message "O campo e-mail deve ser prenchido corretamente"
  ...
  Scenario: Campo Senha vazio
    ...
    And I click on the Register button
    Then I should see the Register error message "O campo senha deve ter pelo menos 6 dígitos"
